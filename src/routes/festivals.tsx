     ...
     <section className="py-5">
      ...
      <section className="py-2">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <Reveal>
            <div className="group overflow-hidden rounded-3xl bg-[#FFF8E7] border border-[#D4AF37]/50 shadow-[0_4px_20px_rgba(0,0,0,0.05)] flex flex-col h-full p-8 md:p-10 ">
              <h3 className="text-2xl md:text-2xl font-serif-tamil font-bold text-[#D9381E] mb-4 "> பஞ்ச மூர்த்தி விழா</h3>
