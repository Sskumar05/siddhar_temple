...
const sections = [
  ...
  { title: "கோவில் கட்டிடக்கலை", img: kovilstructure, content: "சோழர் கால சிற்பக்கலையின் சிறப்பான எடுத்துக்காட்டாக விளங்கும் இக்கோவில், செதுக்கப்பட்ட கல் தூண்கள், அழகான விமானம், விரிவான மண்டபங்களோடு கம்பீரமாய் காட்சியளிக்கிறது. ஒவ்வொரு சிற்பமும் ஒரு வரலாற்றைச் சொல்கிறது." },
  ...
  { title: "சிறப்பு வழிபாடு", img: superway, content: "தினசரி அபிஷேகம், ஆராதனை, அர்ச்சனை, பௌர்ணமி தோறும் சிறப்பு பூஜை, மாதந்தோறும் குரு பூஜை — அனைத்தும் பாரம்பரிய முறையில் செய்யப்படுகின்றன." },
];
