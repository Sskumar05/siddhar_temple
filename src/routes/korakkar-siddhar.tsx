...
const story = [
  ...
  { eyebrow: "ஆன்மீக தத்துவம்", title: "கோரக்கர் பொய்கைநல்லூரில் ஜீவசமாதி அடைதல்" },
  ...
  return (
    <>
      ...
      <section className="py-24">
        ...
        <div>
          <p className="ml-5 sm:ml-108 text-[70%] sm:text-[130%] text-black leading-loose max-w-2xl mx-auto text-left ">[கோரக்கர் அருளிய சந்திரரேகை பாடல் :22-23]</p>
          <p className="mt-2 ml-10 sm:mt-5 sm:ml-120 text-[77%] sm:text-lg text-muted-foreground leading-loose max-w-2xl mx-auto text-left ">
            "புகன்றிடுவேன் போகரவர் பெருமை தன்னைப் <br></br> <span className="ml-8">பூவுலகில் யாவர்களும் பொருந்தி மேவ </span><br></br>அகம் மகிழப் போகநாதர் பழனி தன்னில் <br></br> <span className="ml-8">அடங்கிடுமுன் பாகத்தான் வரலாறு முற்றும்</span> <br></br>இகம் அறியச் செனனசா கரமுஞ் செப்பி <br></br><span className="ml-8">எனையழைத்து உரகை எனும் பதிக்கே கென்றார்</span> <br></br>தகைமையுறச் சித்தரையான் அடக்கம் செய்து <br></br><span className="ml-8">தட்டாமல் உரைகையுற்றுப் பார்த்திட் டேனே."</span>
          </p><br />
          <p className="ml-10 sm:mt-5 sm:ml-120 text-[77%] sm:text-lg text-muted-foreground leading-loose max-w-2xl mx-auto text-left ">
            "பார்த்திருந்த சித்தர்களைப் பார்க்க வைத்தே <br></br><span className="ml-8">பக்குவமாய்ப் போகரவர் தயங்கி டாமல்</span> <br></br>சீர்நிறையென் போலவரை ஏய்த்துப் போட்டுச் <br></br><span className="ml-8">சிதறாமல் உரகையினில் என்னைக் கண்டார்</span> <br></br> போர்விளங்கப் புதுமையுடன் எனைய ழைத்துப் <br></br><span className="ml-8">பொய்கைநல் லூரென்றிடப் பூங்கா சென்றார்</span> <br></br> நேர்மையுடன் எனக்கடக்கம் நிலைமை காட்டி <br></br><span className="ml-8">நெடியகடல் தாண்டிமறு தேசம் போனார்."</span>
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <Reveal>
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <img src="https://res.cloudinary.com/dhjupdyus/image/upload/v1781599742/IMG_20260616_141712_lj4m0w.png" alt="ஜீவசமாதி" loading="lazy" className="rounded-3xl shadow-luxury" />
              <div>
                <div className="text-xs uppercase tracking-[0.3em] text-gold mb-3">கோரக்கர் சித்தரின் கொடை</div>
                <h2 className="text-2xl md:text-3xl font-semibold text-primary">உள் ஒளி உணர்வு மையம் (தியான மண்டபம்)</h2>
